        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    staffcontent = table.Column<string>(name: "staff_content", type: "nvarchar(2000)", nullable: true),
                    servicecontent = table.Column<string>(name: "service_content", type: "nvarchar(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    namefile = table.Column<string>(name: "name_file", type: "nvarchar(500)", nullable: false),
                    typefile = table.Column<string>(name: "type_file", type: "nvarchar(50)", nullable: false),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "longtext", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeFlag = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    name = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    workingfromtime = table.Column<TimeSpan>(name: "working_from_time", type: "time", nullable: false),
                    workingtotime = table.Column<TimeSpan>(name: "working_to_time", type: "time", nullable: false),
                    isdefault = table.Column<ulong>(name: "is_default", type: "bit", nullable: true),
                    description = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    workdays = table.Column<string>(name: "work_days", type: "varchar(30)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedOn = table.Column<DateTime>(type: "datetime", nullable: false),
