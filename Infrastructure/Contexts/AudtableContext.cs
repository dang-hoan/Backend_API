...
{
    public class AudtableContext : IdentityDbContext<AppUser, AppRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, AppRoleClaim, IdentityUserToken<string>>
    {
        protected AudtableContext(DbContextOptions options) : base(options)
        {
        }
